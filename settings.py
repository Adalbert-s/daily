...
# Debug (desabilitar em produÃ¯Â¿Â½Ã¯Â¿Â½o)
DEBUG = True
ALLOWED_HOSTS = ['127.0.0.1', 'localhost']

# Definindo o modelo de usuÃ¯Â¿Â½rio customizado
AUTH_USER_MODEL = 'users.CustomUser'

# Redirecionamento apÃ¯Â¿Â½s login e logout
LOGIN_REDIRECT_URL = '/'
LOGOUT_REDIRECT_URL = '/'
...
# ConfiguraÃ¯Â¿Â½Ã¯Â¿Â½o de API Externa
